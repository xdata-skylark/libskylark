...
.. note:: Elemental-0.87.7 requires a NumPy version >= 1.7. On Ubuntu Precise the deb sources only contain version 1.6.x. To upgrade use either:
...
Currently we only support version v0.87.7 (see
https://github.com/elemental/Elemental/releases/tag/v0.87.7).
