...
`*_DENSE` correspond to the case of El::Matrix<T> (dense) matrix `X`; `*_SPARSE` is for the skylark::base::sparse_matrix_t<T> (sparse) matrix `X`.
...
.. cpp:function:: void read_hdf5(const boost::mpi::communicator& comm, std::string filename, El::Matrix<double>& X, El::Matrix<double>& Y, int blocksize = 10000)

.. cpp:function:: void read_hdf5(const boost::mpi::communicator& comm, std::string filename, skylark::base::sparse_matrix_t<double>& X, El::Matrix<double>& Y, int min_d = 0)
...
.. cpp:function:: void read_libsvm(const boost::mpi::communicator& comm, std::string filename, El::Matrix<T>& X, El::Matrix<T>& Y, int min_d = 0, int blocksize = 10000)

.. cpp:function:: void read_libsvm(const boost::mpi::communicator& comm, std::string filename, skylark::base::sparse_matrix_t<T>& X, El::Matrix<T>& Y, int min_d = 0)
...
.. cpp:function:: void read_model_file(std::string filename, El::Matrix<double>& W)
...
.. cpp:function:: int write_hdf5(const boost::mpi::communicator& comm, std::string filename, El::Matrix<double>& X, El::Matrix<double>& Y)

.. cpp:function:: int write_hdf5(std::string filename, skylark::base::sparse_matrix_t<double>& X, El::Matrix<double>& Y)
     ...
     * For the case of dense matrix input `X` (El::Matrix<double> type) 2 datasets named `X` and `Y` are created in the file for all data.
