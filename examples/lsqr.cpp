...
int main (int argc, char** argv) {
  ...
  if (0==strcmp("elem",chr_params[MATRIX_TYPE_INDEX])) {
    ...
    DenseDistMatrixType A=uni_dense_dist_mat_t::apply
            (int_params[M_INDEX], int_params[N_INDEX], grid, context);
    DenseDistMatrixType B=uni_dense_dist_mat_t::apply
    ...
    SparseDistMatrixType A=uni_sparse_dist_mat_t::apply
            (int_params[M_INDEX], int_params[N_INDEX], NNZ, context);
    SparseMultiVectorType B=uni_sparse_dist_multi_vec_t::apply
            (int_params[M_INDEX], int_params[N_RHS_INDEX], context);
    SparseMultiVectorType X (int_params[N_INDEX], int_params[N_RHS_INDEX]);

    /** Depending on which sketch is requested, do the sketching */
    SparseDistMatrixType sketch_A=empty_sparse_dist_mat_t::apply
            (int_params[S_INDEX], int_params[N_INDEX]);
    SparseMultiVectorType sketch_B=empty_sparse_dist_multi_vec_t::apply
            (int_params[S_INDEX], int_params[N_RHS_INDEX]);
    SparseMultiVectorType sketch_X=empty_sparse_dist_multi_vec_t::apply
