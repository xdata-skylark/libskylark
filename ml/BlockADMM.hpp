...
public:
    ...
    int train(sparse_matrix_t& X, LocalMatrixType& Y, LocalMatrixType& W, sparse_matrix_t& Xv, LocalMatrixType& Yv);

    void predict(DistInputMatrixType& X, DistTargetMatrixType& Y,LocalMatrixType& W);
    void predict(sparse_matrix_t& X, LocalMatrixType& Y,LocalMatrixType& W);
...
int BlockADMMSolver::train(sparse_matrix_t& X, LocalMatrixType& Y, LocalMatrixType& W, sparse_matrix_t& Xv, LocalMatrixType& Yv) {
...
void BlockADMMSolver::predict(sparse_matrix_t& X, LocalMatrixType& Y,LocalMatrixType& W) {
    // TOD W should be really kept as part of the model
...
// move elsewhere
int BlockADMMSolver::classification_accuracy(LocalMatrixType& Yt, LocalMatrixType& Yp) {
    int correct = 0;
        double o, o1;
        int pred;
...
double BlockADMMSolver::evaluate(DistTargetMatrixType& Yt, DistTargetMatrixType& Yp) {
    int correct = classification_accuracy(Yt.Matrix(), Yp.Matrix());
    double accuracy = 0.0;
    int totalcorrect;
...
double BlockADMMSolver::evaluate(LocalMatrixType& Yt, LocalMatrixType& Yp) {
