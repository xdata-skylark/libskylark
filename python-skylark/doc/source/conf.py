...
project = u'LIBSKYLARK'
copyright = u'IBM Corporation 2012-2014.  All Rights Reserved'
...
latex_documents = [
  ('index', 'skylark.tex', u'SKYLARK User Documentation',
   u'IBM SKYLARK Team', 'manual'),
]
...
texinfo_documents = [
  ('index', 'SKYLARK', u'SKYLARK Documentation',
   u'Vikas Sindhwani', 'SKYLARK', 'Randomized Numerical Linear Algebra',
   'Miscellaneous'),
]
