#ifndef SKYLARK_DENSE_TRANSFORM_ELEMENTAL_STAR_ROWDIST_LOCAL_HPP
#define SKYLARK_DENSE_TRANSFORM_ELEMENTAL_STAR_ROWDIST_LOCAL_HPP
...
private:
    ...
    void apply_impl_dist(const matrix_type& A,
        ...
        matrix_type sketch_of_A_STAR_RD(base_data_t::S,
                             base_data_t::N);
        ...
        sketch_of_A_CIRC_CIRC = sketch_of_A_STAR_RD;
...
#endif // SKYLARK_DENSE_TRANSFORM_ELEMENTAL_STAR_ROWDIST_LOCAL_HPP
