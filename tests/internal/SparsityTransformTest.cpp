...
int test_main(int argc, char *argv[]) {
    ...
    elem::DistMatrix<double, elem::VR, elem::STAR> PI(grid);
    elem::Uniform(6, 10, PI);
    elem::Zero(PI);
    PI.Set(4, 0,  1.0);
    PI.Set(5, 1,  1.0);
    PI.Set(5, 2, -1.0);
    ...
    elem::Uniform (6, 5, expected_A);
    elem::Gemm(elem::NORMAL, elem::NORMAL,
               1.0, PI.LockedMatrix(), A.LockedMatrix(),
    ...
    elem::DistMatrix<double, elem::VR, elem::STAR> PI_r(grid);
    elem::Uniform(5, 3, PI_r);
    elem::Zero(PI_r);
    PI_r.Set(0, 1, -1.0);
    PI_r.Set(1, 1, -1.0);
    PI_r.Set(2, 2,  1.0);
    ...
    elem::Uniform (10, 3, expected_AR);
    elem::Gemm(elem::NORMAL, elem::NORMAL,
               1.0, A.LockedMatrix(), PI_r.Matrix(),
