...
template<typename F>
struct typer_t<const El::Matrix<F> > {
    typedef F value_type;
    typedef El::Int index_type;
};
...
template<typename F>
struct typer_t<const El::AbstractDistMatrix<F> > {
    typedef F value_type;
    typedef El::Int index_type;
};
...
template<typename F>
struct typer_t<const El::ElementalMatrix<F> > {
    typedef F value_type;
    typedef El::Int index_type;
};
...
template<typename F, El::Distribution CD, El::Distribution RD>
struct typer_t<const El::DistMatrix<F, CD, RD> > {
    typedef F value_type;
    typedef El::Int index_type;
};
...
template<typename IT, typename VT, typename DT>
struct typer_t<const SpParMat<IT, VT, DT> > {
    typedef VT value_type;
    typedef IT index_type;
};
...
template<typename IT, typename VT>
struct typer_t<const FullyDistVec<IT, VT> > {
    typedef VT value_type;
    typedef IT index_type;
};
#endif
